...
(function () {
  ...
  var I18N = {
    vi: {
      // Document
      'doc.title': 'RÖKTIPS – Ngón tay khỏe hơn cho người chơi guitar & nhạc cụ dây',
      'doc.description':
        'RÖKTIPS – Dành cho người chơi guitar và các nhạc cụ dây muốn ngón tay khỏe hơn, nhanh hơn. Luyện chai tay, sức mạnh và độ linh hoạt ở mọi nơi để chơi lâu hơn, ít đau hơn.',
      ...
      // Banner
      'banner.badge': 'Ưu đãi',
      'banner.text': 'Miễn phí vận chuyển cho mọi đơn RÖKTIPS',
      ...
      'hero.urgency': 'Miễn phí vận chuyển cho mọi đơn RÖKTIPS — giao tận nơi.',
      ...
      // Demo
      'demo.title': 'Xem RÖKTIPS Hoạt Động',
      'demo.subtitle':
        'Xem cách người chơi guitar sử dụng RÖKTIPS để khởi động, tạo chai tay và tranh thủ luyện tập ở mọi nơi.',

      // Benefits
      'benefits.title': 'Vì Sao Người Chơi Guitar Chọn RÖKTIPS',
      'benefits.subtitle':
        'Thiết kế ưu tiên cho guitar và được người chơi nhạc cụ dây khắp nơi sử dụng. 4 cách RÖKTIPS giúp bạn chơi nhiều hơn, bớt đau, và hay hơn.',
      ...
      'benefits.card4.text':
        'Không cần mang đàn—dùng RÖKTIPS tại bàn làm việc, ở nhà, hay khi di chuyển để lên đàn là sẵn sàng.',
      ...
      'how.step1.title': 'Đeo RÖKTIPS vào tay bấm/dàn dây',
      'how.step1.text':
        'Luồn RÖKTIPS vào những ngón bạn dùng nhiều nhất trên cần đàn. Cảm giác ôm vừa vặn và thoải mái, không cần dây đeo hay lắp đặt.',
      'how.step2.title': 'Tập bài siết‑nhả ngắn',
      'how.step2.text':
        'Siết và thả từng ngón trong vài hiệp ngắn. RÖKTIPS mô phỏng lực dây để bạn luyện sức mạnh và chai tay mà không cần mang đàn.',
      ...
      // Comparison
      'comparison.title': 'Không RÖKTIPS vs Có RÖKTIPS',
      'comparison.subtitle': 'Luyện tập của bạn (guitar/nhạc cụ dây) trước và sau, đặt cạnh nhau.',
      'comparison.colWithout': 'Không có RÖKTIPS',
      'comparison.colWith': 'Có RÖKTIPS',
      ...
      'testimonials.subtitle':
        'Tham gia cùng 2.400+ người chơi guitar và nhạc cụ dây dùng RÖKTIPS để luyện tập dễ chịu hơn và nghe hay hơn.',
      ...
      'testimonials.card2.quote':
        'Tôi dùng RÖKTIPS để khởi động nhanh trước khi tập scale và solo. Ngón tay vào “form” nhanh hơn và tôi chơi lâu hơn mà ít mỏi.',
      'testimonials.card2.cite': 'Mia · Người chơi giải trí',
      'testimonials.card3.quote':
        'Tôi là người mới và đầu ngón tay từng rát như bỏng. RÖKTIPS giúp tôi tạo chai tay để có thể kiên trì học hợp âm.',
      'testimonials.card3.cite': 'Alex · Người mới tập guitar',

      // Final CTA
      'cta.urgency': 'Miễn phí vận chuyển cho mọi đơn RÖKTIPS',
      'cta.headline': 'Ngón Tay Khỏe Hơn. Bắt Đầu Ngay.',
      'cta.text':
        'Tham gia cùng hàng ngàn người chơi guitar và nhạc cụ dây đang luyện tập với RÖKTIPS. Không cần mang đàn—chỉ vài phút mỗi lần. Đặt ngay và nhận miễn phí vận chuyển, mọi đơn.',

      // Video modals
      'videoModal.closeAria': 'Đóng video',
      'videoModal.youtubeAria': 'Video demo RÖKTIPS',
      'videoModal.youtubeTitle': 'Video demo RÖKTIPS',
      'videoModal.localAria': 'Video RÖKTIPS',
      'videoModal.noSupport': 'Trình duyệt của bạn không hỗ trợ phát video nhúng.',

      // Interest modal
      'interest.closeAria': 'Đóng biểu mẫu đăng ký',
      'interest.title': 'Đăng ký nhận thông tin RÖKTIPS',
      'interest.subtitle': 'Sắp ra mắt. Hãy để lại thông tin, chúng tôi sẽ báo ngay khi RÖKTIPS mở bán.',
      ...
      'interest.success': 'Cảm ơn bạn! Chúng tôi sẽ thông báo khi RÖKTIPS sẵn sàng.',
      'interest.submit': 'Báo tôi khi RÖKTIPS ra mắt',
      'interest.privacyHtml':
        'Chúng tôi chỉ dùng thông tin của bạn để thông báo về RÖKTIPS và ưu đãi liên quan. Xem <a class="legal-link" href="privacy.html">Chính sách quyền riêng tư</a> và <a class="legal-link" href="terms.html">Điều khoản sử dụng</a>.',

      // Legal pages
      'legal.back': '← Về trang chủ',
      'legal.updated': 'Cập nhật lần cuối: 2026-03-18',
      'privacy.metaTitle': 'Chính sách quyền riêng tư – RÖKTIPS',
      'privacy.metaDescription': 'Chính sách quyền riêng tư của RÖKTIPS.',
      ...
      'privacy.use1': 'Liên hệ về ngày ra mắt RÖKTIPS, tình trạng mở bán và ưu đãi liên quan.',
      ...
      'terms.metaTitle': 'Điều khoản sử dụng – RÖKTIPS',
      'terms.metaDescription': 'Điều khoản sử dụng của RÖKTIPS.',
      ...
      'terms.ipText': 'Mọi nội dung trên website thuộc RÖKTIPS hoặc bên cấp phép và không được sao chép khi chưa được cho phép.',
      ...
      'terms.liabilityText': 'RÖKTIPS không chịu trách nhiệm cho các thiệt hại gián tiếp/phát sinh từ việc bạn sử dụng website.',
      ...
      // Footer
      'footer.copy': '© RÖKTIPS.COM. Bảo lưu mọi quyền.',
    ...
    en: {
      // Document
      'doc.title': 'RÖKTIPS – Stronger Fingers for Guitarists & String Players',
      'doc.description':
        'RÖKTIPS – For guitarists and other string players who want stronger fingers, faster. Build calluses, strength, and dexterity anywhere so you can play longer with less pain.',
      ...
      // Banner
      'banner.badge': 'Offer',
      'banner.text': 'Free shipping on every RÖKTIPS order',
      ...
      // Demo
      'demo.title': 'See RÖKTIPS in Action',
      'demo.subtitle':
        'Watch how real guitarists use RÖKTIPS to warm up, build calluses, and squeeze in extra practice anywhere.',

      // Benefits
      'benefits.title': 'Why Guitarists Choose RÖKTIPS',
      'benefits.subtitle':
        'Designed for guitarists first, and used by string players everywhere. Four ways RÖKTIPS helps you play more, hurt less, and sound better.',
      ...
      'benefits.card4.text':
        'No guitar needed—use RÖKTIPS at your desk, on the sofa, or during your commute and show up to the fretboard already warmed up.',
      ...
      'how.step1.title': 'Slip RÖKTIPS on your fretting/playing hand',
      'how.step1.text':
        'Slide RÖKTIPS onto the fingers you use most on the fretboard or fingerboard. They feel snug but comfortable, with no setup or straps.',
      'how.step2.title': 'Do short squeeze‑and‑release drills',
      'how.step2.text':
        'Squeeze and release each finger for a short set. RÖKTIPS simulate string resistance so you can train strength and calluses without your instrument.',
      ...
      // Comparison
      'comparison.title': 'Without vs With RÖKTIPS',
      'comparison.subtitle': 'What your practice looks like as a guitarist or string player, side‑by‑side.',
      'comparison.colWithout': 'Without RÖKTIPS',
      'comparison.colWith': 'With RÖKTIPS',
      ...
      'testimonials.subtitle':
        'Join 2,400+ guitarists and other string players using RÖKTIPS to make practice feel better and sound better.',
      'testimonials.card1.quote':
      ...
      'testimonials.card2.quote':
        'I use RÖKTIPS for a quick warm‑up before I practise scales and solos. My fingers feel ready way quicker and I can go longer without fatigue.',
      'testimonials.card2.cite': 'Mia · Hobby player',
      'testimonials.card3.quote':
        "I'm a total beginner and my fingertips used to be on fire after 10 minutes. RÖKTIPS helped me build calluses so I could actually stick with learning chords.",
      'testimonials.card3.cite': 'Alex · New guitarist',

      // Final CTA
      'cta.urgency': 'Free shipping on every RÖKTIPS order',
      'cta.headline': 'Get Stronger Fingers. Start Today.',
      'cta.text':
        'Join thousands of guitar players and other string musicians training with RÖKTIPS. No instrument needed—just a few minutes a day. Order now and get free shipping, every time.',

      // Video modals
      'videoModal.closeAria': 'Close video',
      'videoModal.youtubeAria': 'RÖKTIPS demo video',
      'videoModal.youtubeTitle': 'RÖKTIPS demo video',
      'videoModal.localAria': 'RÖKTIPS video',
      'videoModal.noSupport': 'Sorry, your browser doesn’t support embedded videos.',

      // Interest modal
      'interest.closeAria': 'Close registration form',
      'interest.title': 'Register your interest in RÖKTIPS',
      'interest.subtitle':
        "Launching soon. Leave your details and we'll let you know the moment RÖKTIPS goes live.",
      ...
      'interest.phonePlaceholder': '+84 7123 456 789',
      'interest.success': "Thanks for your interest! We'll notify you when RÖKTIPS is available.",
      'interest.submit': 'Notify me when RÖKTIPS launches',
      'interest.privacyHtml':
        'We’ll only use your details to let you know about the RÖKTIPS launch and related offers. See <a class="legal-link" href="privacy.html">Privacy Policy</a> and <a class="legal-link" href="terms.html">Terms of Use</a>.',

      // Legal pages
      'legal.back': '← Back to home',
      'legal.updated': 'Last updated: 2026-03-18',
      'privacy.metaTitle': 'Privacy Policy – RÖKTIPS',
      'privacy.metaDescription': 'Privacy Policy for RÖKTIPS.',
      ...
      'privacy.use1': 'To contact you about the RÖKTIPS launch, availability, and related offers.',
      ...
      'terms.metaTitle': 'Terms of Use – RÖKTIPS',
      'terms.metaDescription': 'Terms of Use for RÖKTIPS.',
      ...
      'terms.ipText':
        'All content on this website is owned by RÖKTIPS or its licensors and may not be copied without permission.',
      ...
      'terms.liabilityText':
        'RÖKTIPS will not be liable for any indirect or consequential damages arising from your use of this website.',
      ...
      // Footer
      'footer.copy': '© RÖKTIPS.COM. All rights reserved.',
